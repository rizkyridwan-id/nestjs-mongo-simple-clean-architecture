...
## Security
This repository implements two-layered security, inspired by best practices observed in various Open API implementations.  this app doesn't use JWT due to client inquiry. follow this docs to add JWT: [Nest JS Passport](https://docs.nestjs.com/recipes/passport). notes: the package and sample code of JWT still exist in the source code, so you can use it immediately by following the guide.
* ### Signature
